...
"""))
game.show_long_text("Parece buen sitio para descansar.", DialogLayout.BOTTOM)
tiles.set_current_tilemap(tilemap("""
    nivel2
"""))
pj = sprites.create(img("""
        e e e . . . . e e e . . . . 
            c d d c . . c d d c . . . . 
            c b d d f f d d b c . . . . 
            c 3 b d d b d b 3 c . . . . 
    ...
    """),
    SpriteKind.player)
scene.camera_follow_sprite(pj)
pj.set_position(30, 30)
controller.move_sprite(pj)
music.big_crash.play()
game.show_long_text("Oh no, eh caído en un laberinto.", DialogLayout.BOTTOM)
