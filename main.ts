scene.setBackgroundImage(img`
    ...
    `)
game.showLongText("Parece buen sitio para descansar.", DialogLayout.Bottom)
tiles.setCurrentTilemap(tilemap`nivel2`)
let pj = sprites.create(img`
    e e e . . . . e e e . . . . 
    c d d c . . c d d c . . . . 
    c b d d f f d d b c . . . . 
    c 3 b d d b d b 3 c . . . . 
    ...
    . f f . . f f . . f f . . . 
    `, SpriteKind.Player)
scene.cameraFollowSprite(pj)
pj.setPosition(30, 30)
controller.moveSprite(pj)
music.bigCrash.play()
game.showLongText("Oh no, eh caído en un laberinto.", DialogLayout.Bottom)
